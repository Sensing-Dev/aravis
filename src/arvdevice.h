...
ARV_API gboolean	arv_device_is_gendc_available				(ArvDevice *device, /*const char *feature,*/ GError **error);
...
ARV_API void*		arv_device_get_register_feature_value	(ArvDevice *device, const char *feature, guint64 length, GError **error);
